...
func build(source: PackedVector3Array, key := "", data: Dictionary = {}) -> void:
	...
	if key == "laguna":
		park_material.set_shader_parameter("low_color", Color("82704d"))
		park_material.set_shader_parameter("high_color", Color("baa478"))
	elif key == "bathurst":
		park_material.set_shader_parameter("low_color", Color("666343"))
		park_material.set_shader_parameter("high_color", Color("989369"))
