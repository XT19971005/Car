...
W/S 油门/制动倒车，A/D 转向，空格手刹，C / F1 切换八种视角，Q 降挡、E 升挡，M 切换自动换挡，**R 回到最近路面并使当前圈失效**，Esc 暂停。手柄 RT/LT 油门/制动，左摇杆转向，Start 暂停。
...
默认手动换挡，起步预挂一挡。停车后用 Q 依次降至空挡、倒挡；倒挡时 W 倒车，S 制动。Q/E 会保持手动模式，带换挡间隔和降挡超转保护。手柄左右肩键分别降/升挡。近追车、远追车、驾驶舱、仪表台、引擎盖、保险杠、头盔和纯路面八个机位均使用固定视野，不随速度拉远；C/F1 循环切换。
